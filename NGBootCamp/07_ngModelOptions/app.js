angular.module('app', [])
  .filter('silly', function() {
    return function(arrayOfPeople, changeTo) {
      console.log(arrayOfPeople, changeTo);
      return arrayOfPeople.map(function(person) {
        return {
          firstName: person.lastName.toLowerCase(),
